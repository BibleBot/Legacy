...
var portuguese_br = require(
  __dirname + "/../i18n/portuguese_br/portuguese_br.json");
...
var languages = {
    ...
    */
    ...
    "catalan": {"name": "Català", "rawobj": catalan,
                "defversion": "ESV", "complete": true },
                // no catalan versions on BibleGateway, yet
    "deflang": {"name": "Default", "rawobj": deflang,
                "defversion": "ESV", "complete": true },
    "english_uk": {"name": "English (UK)", "rawobj": english_uk,
                   "defversion": "ESVUK", "complete": true },
    "english_us": {"name": "English (US)", "rawobj": english_us,
                   "defversion": "ESV", "complete": true },
    "esperanto": {"name": "Esperanto", "rawobj": esperanto,
                  "defversion": "ESV", "complete": true },
                  // despite being public domain,
                  // still no Esperanto bible on BibleGateway
    "french": {"name": "Français", "rawobj": french,
               "defversion": "BDS", "complete": true },
    "norwegian": {"name": "Norsk", "rawobj": norwegian,
                 "defversion": "DNB1930", "complete": true },
    "portuguese": {"name": "Português", "rawobj": portuguese,
                   "defversion": "NVI-PT", "complete": true },
    "portuguese_br": {"name": "Português (BR)", "rawobj": portuguese_br,
                      "defversion": "NVI-PT", "complete": true },
    "scots": {"name": "Scots", "rawobj": scots,
              "defversion": "ESV", "complete": false },
    "spanish": {"name": "Español", "rawobj": spanish,
                "defversion": "NVI", "complete": true },
}
